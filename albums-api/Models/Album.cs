namespace albums_api.Models
{
    public record Album(int Id, string Title, string Artist, int Year, double Price, string Image_url)
    {
        public static List<Album> GetAll()
        {
            ...
            new Album(1, "You, Me and an App Id", "Daprize", 2026, 10.99, "https://aka.ms/albums-daprlogo"),
            new Album(2, "Seven Revision Army", "The Blue-Green Stripes", 2025, 13.99, "https://aka.ms/albums-containerappslogo"),
